...
This repository provides a dedicated ZMK configuration tailored for the **"MiaoMiao" custom wireless Cygnus** split keyboard. It natively supports real-time keymap editing via ZMK Studio, optimizes wireless connectivity and power consumption. It uses nice!nano controllers (please pay attention to the pinout).
---
...
*   **Technical Support**: If you are using a Cygnus split keyboard manufactured by **"MIAOMIAO"** and encounter any issues regarding firmware usage, graphical configuration, or flashing, please feel free to reach out to the author through these channels:
